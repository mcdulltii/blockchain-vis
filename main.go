...
func main() {
	...
	go func() {
		t := time.Now()
		genesisBlock := Block{}
		genesisBlock = Block{0, strings.Split(strings.Split(t.String(), "+")[0], ".")[0], "Head", calculateHash(genesisBlock), ""}
...
func generateBlock(oldBlock Block, BPM string) Block {
	...
	newBlock.Timestamp = strings.Split(strings.Split(t.String(), "+")[0], ".")[0]
	newBlock.BPM = BPM
